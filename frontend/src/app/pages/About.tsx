      ...
      <div className="prose prose-lg max-w-none space-y-8">
        <section>
          <p className="text-xl text-gray-800 leading-relaxed">
            Bem-vindo à <strong>HubBra</strong>, onde a paixão pelo futebol encontra a excelência em produtos! 
        ...
        <section>
          <h2 className="text-3xl font-semibold mb-4">O Que Nos Diferencia</h2>
          <div className="space-y-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Autenticidade Garantida</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Paixão Brasileira</h3>
              <p className="text-gray-700">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Variedade Incomparável</h3>
              <p className="text-gray-700">
        ...
        <section>
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start">
              ...
              <span><strong>Transparência:</strong> Preços justos, sem taxas escondidas</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 font-bold mr-2">✓</span>
              <span><strong>Qualidade:</strong> Apenas produtos originais e certificados</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 font-bold mr-2">✓</span>
              <span><strong>Respeito:</strong> Atendimento humanizado e personalizado</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 font-bold mr-2">✓</span>
              <span><strong>Paixão:</strong> Amor genuíno pelo futebol em tudo que fazemos</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-600 font-bold mr-2">✓</span>
              <span><strong>Compromisso:</strong> Com a satisfação total dos nossos clientes</span>
            </li>
          </ul>
        </section>

        <section>
          <h2 className="text-3xl font-semibold mb-4">Junte-se à Nossa Torcida</h2>
          <p className="text-gray-700 leading-relaxed">
        ...
        <p className="text-center text-lg font-semibold text-green-600 mt-8">
